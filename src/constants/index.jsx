export const features = [
    {
        ...
        text: "Xora takes the stress out of assignments with expert guidance and seamless support. Save time, boost your grades, and enjoy the smarter way to succeed.",
        button: {
            icon: '/images/magictouch.svg',
            title: 'See Testamonials',
        },
    },
    {
        id: '1',
        ...
        text: 'With Xora, your assignments are in expert hands. From tight deadlines to complex topics, we deliver quality work so you can focus on what matters most..',
        button: {
...
export const faq = [
    {
        id: '0',
        question: 'What types of assignments does Xora handle?',
        answer:
            'We handle essays, research papers, case studies, presentations, and more across various academic fields.',
    },
    {
        id: '1',
        question: 'How does the process work?',
        answer:
            'Submit your topic, choose a pricing tier, and provide any specific requirements. We’ll take it from there and deliver your assignment on time.',
    },
    {
        id: '2',
        question: 'Is my personal information secure?',
        answer:
            'Absolutely! We prioritize your privacy and ensure all data remains confidential.',
    },
    {
        id: '3',
...
export const plans = [
    {
        ...
        priceMonthly: 19,
        priceYearly: 12,
        caption: 'Best for solo ',
        features: [
            'Simple topics (10–15 pages)',
            '3 days delivery',
            '1 free revision',
            'Email 24/7 support',
        ],
    ...
    },
    {
        ...
        features: [
            'Moderate topics (up to 20 pages)',
            '2 days delivery',
            '2 free revisions',
            'Email + chat support',
    ...
    },
    {
        ...
        priceMonthly: 49,
        priceYearly: 29,
        caption: 'Exclusively for urgent times',
        features: [
            'Complex/technical topics (20+ pages)',
            '24 Hrs delivery',
...
export const testimonials = [
    {
        ...
        comment:
            "Xora saved me during finals week! The quality of work was amazing, and it was delivered right on time. Highly recommend!",
    },
    {
        id: '1',
        name: 'Mark Erixon',
        ...
        comment:
            "The Premium tier was worth every penny. My assignment was well-researched, and the references were spot on. Xora made my life so much easier!",
    },
    {
        id: '2',
        name: 'Melanie Hurst',
        ...
        comment:
            "I was skeptical at first, but Xora exceeded my expectations. The process was smooth, and the results were outstanding.",
    },
    {
        id: '3',
        name: 'Alicia Barker',
        ...
        comment:
            "Thanks to Xora, I scored an A on my research paper! The team was professional and responsive throughout the process.",
    },
    {
        id: '4',
        name: 'Becky Snider',
        ...
        comment:
            "The support team was so helpful! They guided me through choosing the right tier for my needs. I'll definitely use Xora again.",
    },
    {
        id: '5',
        name: 'Jim Bradley',
        role: 'grade 12th Student',
        avatarUrl: '/images/testimonials/jim-bradley.png',
        comment:
            'Fast, reliable, and excellent quality! Xora has become my go-to for assignments when I\'m short on time.',
    },
];
